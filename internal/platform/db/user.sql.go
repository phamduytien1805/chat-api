...
INSERT INTO user_credentials (
  ...
  $1, $2, $3
) RETURNING user_id, hashed_password, salt
`
...
func (q *Queries) CreateUserCredential(ctx context.Context, arg CreateUserCredentialParams) (UserCredential, error) {
	row := q.db.QueryRow(ctx, createUserCredential, arg.UserID, arg.HashedPassword, arg.Salt)
	var i UserCredential
	err := row.Scan(&i.UserID, &i.HashedPassword, &i.Salt)
	return i, err
}
...
Select user_id, hashed_password, salt from user_credentials u where u.user_id = $1
`
